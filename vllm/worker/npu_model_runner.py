...
class ModelInputForNPU(ModelRunnerInputBase):
    """
    This base class contains metadata needed for possible additional steps,
    e.g., sampling.
    This class for NPU.
    """
    pass
...
class NPUModelRunner(ModelRunnerBase[ModelInputForNPU]):
    ...
    def load_model(self) -> None:
        # TODO: 暂时使用torch_npu格式，MindIE 模型格式待适配,可能需要在model_executor/model_loader下增加mindie.py
